...
{
    self.participateButton = [[UIButton alloc] initWithFrame:CGRectMake(0 + 1, 0, (CYScreanW - 2) / 2, (CYScreanH - 64) * 0.08)];
    ...
    self.releaseButton = [[UIButton alloc] initWithFrame:CGRectMake((CYScreanW - 2) / 2  - 2, 0, (CYScreanW - 2) / 2, (CYScreanH - 64) * 0.08)];
    ...
    _verticalImmage.frame = CGRectMake(0, (CYScreanH - 64) * 0.08-3, CYScreanW/2, 3);
...
- (void) labelClickAButton:(UIButton *)sender
{
    ...
    if (sender == self.participateButton)
    {
        _verticalImmage.frame = CGRectMake(0, (CYScreanH - 64) * 0.08-5, CYScreanW/2, 5);
        if (self.myParticipateArray.count)
        {
            self.currentParticipatePage += 1;
        }
    ...
    {
        _verticalImmage.frame = CGRectMake(CYScreanW/2, (CYScreanH - 64) * 0.08-5, CYScreanW/2, 5);
        if (self.myReleaseArray.count) {
            self.currentReleasePage += 1;
        }
