...
//        [btn setImage:[UIImage imageNamed:@"tabbar_compose_background_icon_add"] forState:UIControlStateHighlighted];
        [btn setBackgroundImage:[UIImage imageNamed:@"erweim"] forState:UIControlStateNormal];
...
//        [self addSubview:_plusButton];
        [_plusButton addTarget:self action:@selector(saoyisaoAction) forControlEvents:UIControlEventTouchUpInside];
    }
    return _plusButton;
}
- (void)saoyisaoAction {
