...
[_s1 setFrame:CGRectMake(0, (self.frame.size.height-height)/2, width, height)];
    [_s2 setFrame:CGRectMake(width,     (self.frame.size.height-height)/2, width, height)];
    [_s3 setFrame:CGRectMake(2 * width,  (self.frame.size.height-height)/2, width, height)];
    [_s4 setFrame:CGRectMake(3 * width,  (self.frame.size.height-height)/2, width, height)];
    [_s5 setFrame:CGRectMake(4 * width,  (self.frame.size.height-height)/2, width, height)];
...
-(void)setNowF:(CGRect)nowF
{
    _nowF = nowF;
    [_s1 setFrame:CGRectMake(0, (_nowF.size.height-height)/2, width, height)];
    [_s2 setFrame:CGRectMake(width,     (_nowF.size.height-height)/2, width, height)];
    [_s3 setFrame:CGRectMake(2 * width,  (_nowF.size.height-height)/2, width, height)];
    [_s4 setFrame:CGRectMake(3 * width,  (_nowF.size.height-height)/2, width, height)];
    [_s5 setFrame:CGRectMake(4 * width,  (_nowF.size.height-height)/2, width, height)];
}
/**
 *  设置评分值
 *
