...
//		[self addSubview:btn];
		...
		//设置引导页上的页面控制器
		self.imagePageControl = [[UIPageControl alloc]initWithFrame:CGRectMake(SCREEN_WIDTH*0.1, SCREEN_HEIGHT*0.9, SCREEN_WIDTH*0.8, 50)];
...
//		self.imagePageControl.currentPageIndicatorTintColor = [UIColor whiteColor];
        ...
        self.imagePageControl.pageIndicatorTintColor          = [UIColor colorWithRed:220.0f/255 green:220.0f/255 blue:220.0f/255 alpha:1.0f];
